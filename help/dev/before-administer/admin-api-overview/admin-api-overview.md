...
>[!NOTE]
>
>如果您想要透過UI管理[!DNL Target]，請參閱[Adobe Target商業從業者指南&#x200B;**&#x200B;的](https://experienceleague.adobe.com/docs/target/using/administer/administrating-target.html?lang=en)管理區段。
>
...
| 參數 | 說明 |
| --- | --- |
| operationId | 作業ID，用來識別其他作業中的作業，此ID與POST要求中傳送的作業相同。 |
