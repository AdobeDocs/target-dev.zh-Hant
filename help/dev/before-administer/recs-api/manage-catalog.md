...
1. 導覽至&#x200B;**[!UICONTROL 目標]** > **[!UICONTROL 設定]** > **[!UICONTROL 主機]** > **[!UICONTROL 控制環境]**，以取得您想要新增或更新專案的目標環境識別碼。
...
1. 現在輪到你了！ 使用&#x200B;**[!UICONTROL 儲存實體]** API將下列專案新增至您的目錄。 使用上述範例JSON作為起點。 （您需要擴充JSON以包含其他實體。）

   ![SaveEntities6.png](assets/SaveEntities06.png)

看來最後兩個專案並不屬於。 讓我們使用&#x200B;**[!UICONTROL Get Entity]** API來檢查這些專案，如有必要，請使用&#x200B;**[!UICONTROL Delete Entities]** API來刪除它們。
...
1. 傳送另一個&#x200B;**[!UICONTROL 取得Entity]**&#x200B;要求，這次檢查其entityId=kit2005的實體。
...
1. 瀏覽至&#x200B;**[!UICONTROL Target]** > **[!UICONTROL 安裝程式]** > **[!UICONTROL 主機]** > **[!UICONTROL 環境]**，以取得您要刪除專案的目標環境識別碼。
...
1. 使用&#x200B;**[!UICONTROL 取得實體]**&#x200B;來驗證您的結果，現在應該表示找不到已刪除的實體。
