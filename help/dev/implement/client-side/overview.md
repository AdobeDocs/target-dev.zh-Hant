...
請參閱[比較at.js程式庫與Web SDK](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/web-sdk/personalization/adobe-target/web-sdk-atjs-comparison){target=_blank}，瞭解這兩種實作方法之間的差異。