...
透過[本教學課程](https://experienceleague.adobe.com/docs/platform-learn/migrate-target-to-websdk/introduction.html?lang=zh-Hant)，瞭解如何將您的[!DNL Target]實作從at.js 2.*x*&#x200B;移轉至[!DNL Adobe Experience Platform Web SDK]。
