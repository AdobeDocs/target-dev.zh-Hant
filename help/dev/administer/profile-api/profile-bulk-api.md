...
如果您不知道使用者端代碼，請在[!DNL Target]使用者介面中按一下&#x200B;**[!UICONTROL 管理]** > **[!UICONTROL 實作]**。 使用者端代碼會顯示在[!UICONTROL 帳戶詳細資料]區段中。
...
| [!UICONTROL 未完成] | 設定檔批次更新請求仍在處理中，尚未完成。 |
